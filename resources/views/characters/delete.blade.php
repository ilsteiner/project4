	...
	<div class="row">
		<div class="col-md-6">
			<form action="/characters/{{ $character->id }}" method="POST">
				...
				<button type="submit" class="btn-danger btn btn-lg btn-block">Yes! Get rid of them!</button>
			</form>
		</div>
		<div class="col-md-6">
			<a href="/characters/show/{{ $character->id }}">
				<button type="button" class="btn-info btn btn-lg btn-block">No! I didn't mean to do that!</button>
			</a>
		</div>
	</div>
@stop