		...
		<div class="row">
			<div class="col-md-2">
				<div class="form-group{{ ($errors->has('prefix') ? ' has-error' : '' ) }}">
					...
					<input type="text" id="prefix" name="prefix" placeholder="Mr." class="form-control" value="{{ (isset($character->prefix) ? $character->prefix : "" )}}">
	...
	<fieldset>
		...
		<div class="col-md-10">
			<div class="form-group{{ ($errors->has('short_description') ? ' has-error' : '' ) }}">
				...
				value="{{ (isset($character->short_description) ? $character->short_description : "" )}}">
